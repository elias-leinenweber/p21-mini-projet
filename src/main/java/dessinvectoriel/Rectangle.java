...
public class Rectangle extends Surface {
	 ...
	 *
	 * @param position un {@link Vecteur} indiquant la position du coin supérieur
	 *                 gauche du rectangle
	 * @param longueur la mesure de la longueur du rectangle
	 * @param largeur la mesure de la largeur du rectangle
	 * @throws IllegalArgumentException si la longueur est inférieure à la largeur
	 */
	...
	/**
	 * Initialise un rectangle avec la position, l'orientation, la longueur et la
	 * largeur spécifiées.
	 * <p>
	...
	public Rectangle(Vecteur position, Angle orientation, double longueur, double largeur, Color couleurTrait, int epaisseurTrait, Color couleurRemplissage)
	{
		super(position, orientation, couleurTrait, epaisseurTrait,
		    couleurRemplissage);
		if (longueur < largeur)
			throw new IllegalArgumentException("Longueur inférieure à largeur : " + longueur);
	 ...
	 * <i>l</i> est donné par la formule <i>s = L &sdot; l</i>.
	 *
	 ...
	 * <i>l</i> est donné par la formule <i>p = 2 &sdot; (L + l)</i>.
	 *
	...
	/**
	 * Renvoie une représentation sous forme de chaîne de caractères de ce rectangle.
	 *
	 * @return une chaîne de caractères indiquant position, orientation, longueur,
	 *         largeur, épaisseur de trait, couleur de trait et couleur de
	 *         remplissage de ce rectangle
	 */
	@Override
