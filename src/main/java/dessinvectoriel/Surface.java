...
public abstract class Surface extends Figure {
	 ...
	 * <p>
	 * Les autres propriétés de la surface sont initialisés par défaut.
	 *
	 ...
	 *
	 * @param position un {@link Vecteur} indiquant la position de la surfac
	 * @param orientation un {@link Angle} indiquant l'orientation de la surface
	 ...
	 * <p>
	 * Si la couleur spécifiée est la référence {code null}, la surface n'est pas
	 * remplie et reste transparente.
	 *
	 * @param couleurRemplissage un objet {@link Color} indiquant la nouvelle
	 *                           couleur de remplissage ou la référence {@code null}
	 *                           s'il ne faut pas remplir la surface
	 */
	 ...
	 * <p>
	 * Si la couleur renvoyée est la référence {@code null}, la surface n'est pas
	 * remplie et reste transparente.
	 *
	 ...
	 * @return la valeur booléenne {@code true} s'il faut remplir la surface (si la
	 *         couleur de remplissage n'est pas la référence {@code null}) ;
	 *         {@code false} sinon
	 ...
	 * créée sans préciser une valeur de couleur de remplissage.  Initialement, la
	 * couleur de remplissage par défaut est la référence {@code null} et par défaut
	 * les surfaces ne sont pas remplies et sont donc transparentes.
	 *
