...
public abstract class Figure {
	 ...
	 * @param epaisseurTrait un entier indiquant l'épaisseur du trait en nombre de
	 *                       pixels
	 */
	 ...
	 * <p>
	 * Les autres propriétés de la figure sont initialisés par défaut.
	 *
	 * @param position un {@link Vecteur} indiquant la position de la figure
	 * @param orientation un {@link Angle} indiquant l'orientation de la figure
	 */
	 ...
	 *
	 * @param couleur la nouvelle couleur à utiliser pour tracer le trait entourant
	 *                cette figure
	 */
	...
	/**
	 * Modifie l'épaisseur du trait pour cette figure.  Si l'épaisseur du trait est
	 * négative ou nulle, aucun trait ne sera tracé.
	 *
	 ...
	 *
	 * @param position un {@link Vecteur} indiquant la nouvelle position de cette
	 *                 figure
	 */
	 ...
	 *
	 * @return une figure de mêmes position, orientation, dimension(s), épaisseur de
	 ...
	 *         dimension(s), épaisseur de trait et couleur de trait de cette figure
	 */
	@Override
	 ...
	 * L'angle spécifié est ajouté à l'orientation de la figure.  La position de la
	 * figure reste identique.
	 *
	 * @param angle un {@link Angle} indiquant la mesure de la rotation à effectuer
	 */
	...
	/**
	 * Tourne cette figure dun angle donné autour d'un point spécifié.
	 *
	 * @param centre un {@link Vecteur} indiquant les coordonnées du point autour
	 *               duquel il faut effectuer la rotation
	 * @param angle un {@link Angle} indiquant la mesure de la rotation à effectuer
	 */
	 ...
	 * @return la valeur booléenne <code>true</code> s'il faut tracer le trait (si
	 *         l'épaisseur du trait est positive) ; <code>false</code> sinon
	 */
	 ...
	 * <p>
	 * L'épaisseur du trait par défaut est utilisée lorsqu'une figure est créée sans
	 * préciser une valeur d'épaisseur de trait.  Initialement sa valeur est de
	 * 1 pixel.
	 *
	 ...
	 * 1 pixel.
	 *
	 * @param epaisseurTraitParDefaut le nombre de pixels à utiliser par défaut pour
	 *                                tracer le trait de contour d'une figure
	 */
	 ...
	 * <p>
	 * La couleur du trait par défaut est utilisée lorsqu'une figure est créée sans
	 * préciser une valeur de couleur de trait.  Initialement sa valeur est
	 * {@link Color#BLACK}.
	 *
	 ...
	 * {@link Color#BLACK}.
	 *
	 * @param couleurTraitParDefaut un objet {@link Color} qui détermine la nouvelle
	 *                              couleur à utiliser par défaut pour tracer le
	 *                              trait d'une figure
	 */
